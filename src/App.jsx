     ...
     <div className='main h-screen w-[100%]'>
          <nav className='navbar fixed h-[120px] w-full flex p-[30px] justify-center items-center gap-[45px]'>
            ...
            <div className='w-full h-screen flex justify-center items-center flex-col select-none'>
              <h1 className='namelogo drop-shadow-lg text-[100px] sm:text-[180px]  flex justify-center items-center tracking-wide animate-pulse'><span className='text-yellow-200'>R</span><span className='text-yellow-200'>𝓸</span><span className='text-yellow-200'>h</span><span className='text-yellow-100'>i</span><span className='text-yellow-100'>t</span><span>.</span></h1>
